...
?>
           ...
           <span>|</span>
            <div class="article-total_pending_payout_value meta">
                <?php echo $model->convert_currency($model->total_pending_payout_value)?>
            </div>
            <span>|</span>
            <div class="article-date left_margin meta">
                <?php echo Yii::$app->formatter->asRelativeTime($model->created_at) ?>
            </div>
           
            <span>|</span>
            <div class="Icon voters meta">
            ...
            <span>|</span>
             <div class="article-vote-up meta">
