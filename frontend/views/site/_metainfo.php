...
?>
     <div class ="col-xs-12 col-md-7 article-metainfo">
           ...
           <span>|</span>
            <div class="article-total_pending_payout_value">
                <?php echo $model->convert_currency($model->total_pending_payout_value)?>
            </div>
            <span>|</span>
            <div class="article-date left_margin">
                <?php echo Yii::$app->formatter->asRelativeTime($model->created_at) ?>
            </div>
           
            <span>|</span>
            <div class="Icon voters">
