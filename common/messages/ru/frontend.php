...
return [
    ...
    'Choose a type of content for publishing:' => 'Выбери тип контента для публикации:',
    ...
    'Share your adventure stories' => 'Расскажи историю своего приключения',
    'Tell about interesting places to visit' => 'Расскажи о интересных местах, которые стоит посетить',
    'Events' => 'События',
    ...
    'Distribution of tokens' => 'Распределение токенов',
    'Currency' => 'Валюта',
    'Bonus (%)' => 'Бонус (%)',
    'Week stake (%)'=> 'Недельная доля (%)',
...
'Use basic html syntax, MarkDown is not supported' => 'Используется базовый синтаксис html, MarkDown не поддерживается',   
   ...
   '- <b>Adventure</b> - tell the story of your adventure;' => '- <b>Приключения</b> - расскажи историю твоего приключения;',
    ...
    'Copy' => 'Скопировать',
    'Articles' => 'Статьи',
      'If you have not registered, do it <a href="{link}">here</a>.' => 'Если вы еще не зарегистрированы, сделайте это <a href="{link}">здесь.</a>.',
    'Get posting key' => 'Получить постинг-ключ',
    'Get posting key from password' => 'Получить постинг-ключ из пароля',
    ...
    'Distributed tokens: ' => 'Распределенные токены: ',
    'Auction' => 'Аукцион', 
    ...
    'Forecast, $' => 'Прогноз, $',
    'Withdraw' => 'Вывод',
    'Available refferal bonuse: ' => 'Доступный реферальный бонус: ',
    'Referal link: ' => 'Реферальная ссылка: ',
    'Available: ' => 'Доступно: ',
    'Referal bonuses' => 'Реферальные бонусы',
    'BTC Wallet' => 'BTC Кошелек',
    'Amount, BTC' => 'Сумма, BTC',
    'Enter a BTC-Wallet' => 'Введите BTC-кошелек',
    'Amount to Withdraw' => 'Сумма для вывода',
    'Referer' => 'Реферер',
    'Amount' => 'Сумма',
    'Status' => 'Статус',
    'History investments' => 'История инвестиций',
    'Evaluation of IT start-ups' => "",
    'Blog Mapala-Team' => 'Блог команды Mapala',
    'Lots' => 'Лоты',
    'Lot' => 'Лот',
