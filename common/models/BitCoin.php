...
class BitCoin extends Model
{
    ...
    static function create_address($username){
        $apiKey = env('APIKEY');
    ...
    static function get_user_btc_investments(){
        $user = Yii::$app->user->identity->username;
        $btc = ICO::find()->where(['name' => $user])->asArray()->all();
        return $btc;
    }
    
    static function get_user_wallet(){
       $user = Yii::$app->user->identity->username;
    ...
    static function get_personal_gbg(){
        $user = Yii::$app->user->identity->username;
    ...
    static function get_personal_btc(){
        $user = Yii::$app->user->identity->username;
